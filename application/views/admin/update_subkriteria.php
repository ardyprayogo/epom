<div class="container">
    ...
    <div class="col">
      <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Update Sub Kriteria</li>
        </ol>
      </nav>
      <h1 class="display-4">
  ...
  <div class="row mt-3">
    <div class="col">
      <?php echo form_open('admin/update_subkriteria/'.$result['id_sub']); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="subkriteria" placeholder="Sub Kriteria" value="<?php echo $result['sub'] ?>">
          <small class="text-info"><?php echo form_error('subkriteria') ?></small>
        </div>
        <div class="form-group">
          <small class="text-muted">Kuesioner</small>
          <textarea name="ket" class="form-control" rows="5" placeholder="Keterangan / Kuesioner"><?php echo $result['ket'] ?></textarea>
